...
public class GetMedicoByNameQueryHandler : IRequestHandler<GetMedicoByNameQuery, Response<IReadOnlyList<MedicoResponse>>>
{
    ...
    public GetMedicoByNameQueryHandler(IAsyncRepository<Medico> medicoRepository, IMapper mapper, IAppLogger<GetMedicoListQueryHandler> appLogger)
    {
    ...
    public async Task<Response<IReadOnlyList<MedicoResponse>>> Handle(GetMedicoByNameQuery request, CancellationToken cancellationToken)
    {
