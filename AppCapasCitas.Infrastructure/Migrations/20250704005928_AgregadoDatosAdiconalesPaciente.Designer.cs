...
namespace AppCapasCitas.Infrastructure.Migrations
{
    ...
    [Migration("20250704005928_AgregadoDatosAdiconalesPaciente")]
    partial class AgregadoDatosAdiconalesPaciente
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppCapasCitas.Domain.Models.Paciente", b =>
                {
                    ...
                    b.Property<string>("CiudadAseguradora")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ciudad_aseguradora");

                    b.Property<string>("CodigoPostal")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("codigo_postal");

                    b.Property<string>("CodigoPostalAseguradora")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("codigo_postal_aseguradora");
                    ...
                    b.Property<string>("DireccionAseguradora")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("direccion_aseguradora");

                    b.Property<string>("EnfermedadesCronicas")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("enfermedades_cronicas");

                    b.Property<string>("EstadoAseguradora")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("estado_aseguradora");
                    ...
                    b.Property<string>("NombreAseguradora")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("nombre_aseguradora");

                    b.Property<string>("NumeroIdentificacion")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("numero_identificacion");

                    b.Property<string>("NumeroSeguroMedico")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("numero_seguro_medico");
                    ...
                    b.Property<string>("ObservacionesAdicionales")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("observaciones_adicionales");

                    b.Property<string>("Ocupacion")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ocupacion");

                    b.Property<string>("PaisAseguradora")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("pais_aseguradora");

                    b.Property<string>("SeguroMedico")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("seguro_medico");

                    b.Property<string>("Sexo")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("sexo");

                    b.Property<string>("TelefonoAseguradora")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("telefono_aseguradora");
            ...
            modelBuilder.Entity("AppCapasCitas.Domain.Models.Medico", b =>
                {
                    b.HasOne("AppCapasCitas.Domain.Models.Usuario", "Usuario")
                        .WithOne("Medico")
            ...
            modelBuilder.Entity("AppCapasCitas.Domain.Models.UsuarioLogAccion", b =>
                {
                    b.HasOne("AppCapasCitas.Domain.Models.TipoAccion", "TipoAccion")
                        .WithMany()
